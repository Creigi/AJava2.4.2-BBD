...
Функциональность: Авторизация
  ...
  # Задача №2
  Сценарий: : Перевод авторизованным пользователем 5_000 рублей с карты 5559 0000 0000 0002 на 1 карту (позитивный)
    Пусть пользователь залогинен с именем "vasya" и паролем "qwerty123"
    Когда пользователь переводит 5000 рублей с карты "5559 0000 0000 0002" на свою 1 карту с главной страницы
